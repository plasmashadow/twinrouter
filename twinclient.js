//From https://github.com/haggy/Ajaxy-Websockets/blob/master/client/ajaxy-socket-client.js
...
AjaxySocket.prototype = {
    ...
    start: function(cb) {
        ...
        this.socket = WebSocket.connect(this.opts.socketURL, {
          transport: 'websocket'
        });//new WebSocket(this.opts.socketURL);
